...
class UserServiceImplTest {
    ...
    @Test
    void testAddUser() {
        User user = new User(1L, "Nandhini", "Raju", "IT");
    ...
    void testAddUserAlreadyExists() {
        User existingUser = new User(1L, "Nandhini", "Raju", "IT");
    ...
    void testFindAllUsers() {
        ...
        users.add(new User(1L, "Nandhini", "Raju", "IT"));
        users.add(new User(2L, "Jamuna", "Smrithi", "HR"));
    ...
    void testUpdateUser() {
        ...
        User updatedUser = new User(userIdToUpdate, "Nagarjuna", "King", "Finance");
    ...
    void testDeleteUser() {
        ...
        User userToDelete = new User(userIdToDelete, "Nandhini", "Raju", "IT");
